...
import { KeyboardMapper } from "../../keyboard";
...
function createChip8(): Chip8 {
    return new Chip8({
        ...
        keyregs: new Registers(KEYBOARD_MAPPER.keys.length),
    });
}
...
export class Chip8App extends React.Component<Props, State> {
    private readonly keyboardMapper: KeyboardMapper;
    ...
    public constructor(props: Props) {
        ...
        this.keyboardMapper = KEYBOARD_MAPPER;
    ...
    public render(): React.ReactNode {
        return (
            <div
                className="chip8App"
                onKeyDown={(e): void =>
                    this.chip8.setKeyPress(this.keyboardMapper.translate(e.key), true)
                }
                onKeyUp={(e): void =>
                    this.chip8.setKeyPress(this.keyboardMapper.translate(e.key), false)
                }
                tabIndex={0}
            >
                ...
                <div className="gridContainer">
                        ...
                        <div className="controls">
                            <span className="controlSection">
                                {this.state.hasStarted && (
                                    ...
                                    >
                                        <FontAwesomeIcon
                                            icon={this.state.running ? faPause : faPlay}
                                        />
                                    </button>
                                )}
                                <button
                                ...
                                >
                                    <FontAwesomeIcon
                                        icon={this.state.hasStarted ? faStop : faPlay}
                                    />
                                </button>
                            </span>
                            <span className="controlSection">
                    ...
                    <div className="gridItem">
                        <KeyPad
                            ...
                            onButtonDown={(nativeKey): void =>
                                this.chip8.setKeyPress(nativeKey, true)
                            }
                            onButtonUp={(nativeKey): void =>
                                this.chip8.setKeyPress(nativeKey, false)
                            }
                        />
                    </div>
                </div>
